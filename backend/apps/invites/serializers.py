...
from .models import ProjectInvite, InviteProductAccess
...
class ProjectInviteSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'is_accepted', 'accepted_at', 'invited_by_name', 
            'project_name', 'product_access', 'is_expired'
        ]
        read_only_fields = [
            'id', 'created_at', 'expires_at', 'is_accepted', 
            'accepted_at', 'invited_by_name', 'project_name', 'is_expired'
        ]


class CreateInviteSerializer(serializers.Serializer):
    email = serializers.EmailField()
    role = serializers.ChoiceField(choices=ProjectInvite.ROLE_CHOICES, default="producer")
...
class InviteDetailsSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'email', 'role', 'created_at', 'expires_at',
            'project_name', 'project_description', 'invited_by_name', 
            'invited_by_email', 'product_access', 'is_expired'
        ]
